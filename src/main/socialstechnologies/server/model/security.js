...
var dbUri = mongodbUri.formatMongoose('mongodb://socialstech:G5XsQwD0wzdZz4ox@cluster0-shard-00-00-z6umu.mongodb.net:27017,cluster0-shard-00-01-z6umu.mongodb.net:27017,cluster0-shard-00-02-z6umu.mongodb.net:27017/security?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin'); //process.env.MONGO_DB_SECURITY);
var options = {
	replset: {
